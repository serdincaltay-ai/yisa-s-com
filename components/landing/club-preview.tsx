...
const clubs = [
  { name: "Tuzla Cimnastik SK", abbr: "TCSK", primary: "#1e3a5f", secondary: "#e8b530", accent: "#2a5298" },
  { name: "Trabzonspor", abbr: "TS", primary: "#6b0c13", secondary: "#37bfef", accent: "#87171F" },
  { name: "Beşiktaş JK", abbr: "BJK", primary: "#000000", secondary: "#FFFFFF", accent: "#888888" },
  { name: "Fenerbahçe SK", abbr: "FB", primary: "#001e62", secondary: "#ffed00", accent: "#003DA5" },
  { name: "Kendi Kulübünüz", abbr: "?", primary: "#818cf8", secondary: "#f59e0b", accent: "#06b6d4" },
]
    ...
    <section className="py-24 md:py-32 relative bg-white/[0.01]" ref={ref}>
      <div className={`max-w-6xl mx-auto px-4 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-white/50 max-w-2xl mx-auto text-pretty">
