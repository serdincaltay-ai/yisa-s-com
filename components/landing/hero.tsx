...
const slogans = [
  ...
  "Hizmette kalite ilkesiyle kendi robotlarını üreten kulüp",
  "YİSA-S teknolojisiyle deneme sürümünü yayınlamak üzere",
  "Tuzla Cimnastik Spor Okulu ile yine bir ilk, yine bir yenilik",
]
...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-24 md:py-0 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-sm font-mono tracking-widest text-[#818cf8]/60 uppercase mb-2 animate-[slideUp_0.8s_ease-out]">
            Tuzla Cimnastik Spor Kulübü & Hobi GYM
          </p>

          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white mb-4 text-balance leading-tight animate-[slideUp_0.8s_ease-out]">
            Teknolojiyi{" "}
          ...
          <div className="h-8 mb-6 overflow-hidden">
            <p key={idx} className="text-lg text-[#00d4ff]/80 font-mono tracking-wide animate-[fadeInUp_0.5s_ease-out]">
              {`"${slogans[idx]}"`}
            </p>
          </div>

          <p className="text-base text-white/60 max-w-lg mb-8 leading-relaxed text-pretty animate-[slideUp_0.8s_ease-out_0.4s_both]">
            Tuzla Cimnastik Spor Okulu ile yine bir ilk, yine bir yenilik.
            Hizmette kalite ilkesiyle kendi robotlarını üreterek YİSA-S
            teknolojisiyle hizmet vermek için deneme sürümünü yayınlamak üzere.
            Spor artık sporcuya göre: sağlık, gelişim, yetenek, eğlence ve hedefler.
          </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#060a13]/90 backdrop-blur-sm" onClick={() => setShowVideo(false)}>
          <div className="relative w-full max-w-4xl mx-4 aspect-video rounded-xl overflow-hidden border border-white/10 bg-[#0a0f1a]" onClick={(e) => e.stopPropagation()}>
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Tanıtım Videosu Hazırlanıyor</h3>
              <p className="text-sm text-white/50 max-w-md">
                YİSA-S yapay zeka destekli spor okulu yönetim platformunun tanıtım videosu hazırlanıyor. Yakında burada!
              </p>
            </div>
